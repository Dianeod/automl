...
proc.xv.seed:{[xtrn;ytrn;p;mdls]
  ...
  xtrn:$[mdls[`fnc]~`nlp;xtrn[;where 10h=type each first xtrn];xtrn[;where not 10h=type each first xtrn]];
    $[ms&sk;
...
xv.fitpredict:{[f;hp;d]($[0h~type hp;f[d;hp[0];hp[1];1b];@[.[f[][hp]`:fit;d 0]`:predict;d[1]0]`];d[1]1)}

xv.fitpredictprob:{[f;hp;d]($[0h~type hp;f[d;hp[0];hp[1];0b];@[.[f[][hp]`:fit;d 0]`:predict_proba;d[1]0]`];d[1]1)}
